...
for course in all_courses:
    course_num = "COMP " + course.split(" - ")[0].split()[1]
    course_sections[course_num].append(course)
...
assignments_df["Course Num"] = assignments_df["CourseID"].str.extract(r"COMP (\d+)").astype(int)
